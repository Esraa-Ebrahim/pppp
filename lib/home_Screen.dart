        ...
        child: ListView(
          children: [
            DrawerHeader(
              decoration: BoxDecoration(
                image: DecorationImage(
                    image: AssetImage("assetss/img_1.png"), fit: BoxFit.cover),
              ),
              child: (Column(
                children: [
                  Stack(
                    children: [
                      CircleAvatar(
                          ...
                          backgroundImage: _imageFile == null
                              ? const AssetImage("assetss/actor.png")
            ...
            ListTile(
              ...
              title: Text(
                'ID',
                style: TextStyle(color: petroleum),
              ),
            ),
            Divider(
              color: grey,
      ...
      bottomNavigationBar: ClipRRect(
        ...
        child: BottomNavigationBar(
          ...
          items: [
            ...
            BottomNavigationBarItem(
              icon: Image.asset(
                "assetss/icons8-new-message-90.png",
            ...
            BottomNavigationBarItem(
              icon: Image.asset(
                "assetss/icons8-contact-us-48.png",
                width: MediaQuery.of(context).size.width / 10,
                height: MediaQuery.of(context).size.width / 10,
              ),
              label: "",
