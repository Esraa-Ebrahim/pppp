        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child:Image.asset("assetss/text2.png",
                  ...
                  children: [
                    DecoratedBox(
                        decoration: BoxDecoration(
                          color:Color.fromRGBO(218, 221, 222, 1.0), //background color of dropdown button
                          border: Border.all(color:Color.fromRGBO(31, 122, 139, 1.0), width:1.5), //border of dropdown button
                            ...
                            child: DropdownButton(
                              ...
                              items: [
                                ...
                                return DropdownMenuItem<String>(
                                  ...
                                  child: Text(
                                    value,
                                    style: TextStyle(color: Color.fromRGBO(31, 122, 139, 1.0)),
                                  ),
                                );
                              }).toList(),
                              ...
                              iconEnabledColor: Color.fromRGBO(31, 122, 140, 1.0), //Icon color
                              style: TextStyle(  //te
                                  color: Color.fromRGBO(31, 122, 140, 1.0), //Font color
          ...
          Container(
           ...
           onPressed: () {
           Navigator.push(
           context, MaterialPageRoute(builder: (context) => write_Excuse()));
           },
           child: const Text(
            'Confirm',
               style: TextStyle(
